        ...
        <div className='max-w-[1040px] mx-auto'>
            <div className=''>
                < div className="text-center px-3 md:px-0" >
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium text-[#2D2D2D]">
                        Our Plans scale
                    </h3>
                    <div className='flex items-center justify-center gap-2'>
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium text-[#2D2D2D] mb-3">
                            with Every
                        </h3>
                        <button className='text-2xl sm:text-3xl md:text-4xl text-primaryColor font-medium bg-gradient-to-l from-[#3f8afc] to-[#DAE9FF] px-2 py-1 md:px-[10px] md:py-[14px] rounded-sm'>Operation</button>
