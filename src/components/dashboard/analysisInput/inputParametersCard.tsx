...
//   timeAgo: string;
// };
// type CardVariant = 'input' | 'solution' | 'saturation';
...
//   // If no alerts, maybe show a message or nothing
//   if (!inputParams || inputParams.length === 0) {
//     return null; // or return a "No issues" message
//   }
...
//           <button
//             onClick={() => setIsOpen(!isOpen)}
//             className="text-gray-400 hover:text-gray-600 transition-colors duration-300 cursor-pointer"
//           >
//             <IoIosArrowUp
//               className={`transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
//               size={22}
...
//                       {alert.element} ({alert.symbol})
//                     </h3>
//                     <span className="bg-[#FB2C361A] text-[#FF6467] px-3 py-1 rounded-sm text-sm font-medium">
//                       critical
//                     </span>
//                   </div>
//                   <p className="text-[#FF6467] text-sm mb-2">{alert.description}</p>
