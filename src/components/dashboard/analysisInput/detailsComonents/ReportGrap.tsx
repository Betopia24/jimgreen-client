...
const GraphSection: React.FC<Props> = ({ report, id }) => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      if (res?.success) {
        ...
        setNewGraphUrl(res.data.waterReport.parameterGraph.graph_url);
      }
  ...
  const graphUrl = newGraphUrl || report?.parameterGraph?.graph_url;
  console.log(report?.parameter_graph);
