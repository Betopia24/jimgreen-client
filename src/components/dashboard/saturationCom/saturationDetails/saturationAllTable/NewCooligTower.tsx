...
//   return (
//     <div className="bg-white border border-slate-200 rounded-xl mb-3 overflow-hidden shadow-sm">
//       <button
...
//                 <td className="px-3 py-2.5 text-sm font-semibold text-slate-800">
//                   {cta.range?.range_f != null ? `${cta.range.range_f} °F` : "—"}
//                 </td>
//               </tr>
//               <tr>
//                 <td className="px-3 py-2.5 text-sm text-slate-500">
...
//                     cta.wet_bulb_temp_c != null && (
//                       <span className="ml-2 text-[11px] text-orange-500 font-normal">
//                         Needs to be captured by AI based on location
//                       </span>
//                     )}
//                 </td>
//               </tr>
