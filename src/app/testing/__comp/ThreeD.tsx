...
// // NOTE: green color in COLOR_MAP is a placeholder; actual bar color for "green"
// // is computed dynamically as a light→dark gray gradient based on SI magnitude.
// const COLOR_MAP: Record<string, number> = {
//   yellow: 0xe8a800,
//   red: 0xd93025,
//   green: 0x9ca3af, // placeholder – overridden per-bar in buildScene
// };
...
// /** Linearly interpolate a hex color between two endpoints, t ∈ [0, 1]. */
...
//   green: "bg-gray-100   text-gray-600    border border-gray-300", // ← was emerald
...
//     // tempUniq is sorted descending, so index 0 = highest temp → front of Z axis
...
//   // Floor grid — darker lines
//   const gridW = Math.max(nCoC, nTemp) * SPACING + SPACING;
//   const gridHelper = new THREE.GridHelper(
//     gridW + 4,
//     (nCoC + nTemp) * 3,
//     0x64748b, // center lines: slate-500
//     0x94a3b8, // cell lines:   slate-400
//   );
...
//   // tempUniq is sorted descending: highest temp at index 0 → rendered at lowest z (front).
//   // Labels are placed accordingly so temperature increases as z increases (toward back).
...
//   // ── Temperatures sorted DESCENDING so highest temp renders at front (low z) ──
...
//       );
//     // Teal #1abc9c for hover, deep blue for selected/active
...
//                   : label === "Scale Risk"
//                     ? "bg-red-500"
//                     : "bg-gray-400"; // ← was bg-emerald-500
//               return (
//                 <div
//                   key={label}
...
//                       hex: COLOR_HEX.green, // #9ca3af — matches bar gradient mid-tone
//                       bg: "bg-gray-50 border-gray-200", // ← was emerald
//                     },
//                     {
//                       label: "Caution",
...
//                 {/* Gray gradient legend for Protected bars */}
...
//                                 entry?.SR != null && entry.SR > 0
//                                   ? "text-red-600"
//                                   : "text-slate-400"
//                               }`}
//                             >
//                               {entry?.SR != null ? entry.SR : "—"}
//                             </span>
//                           </div>
//                         );
//                       })}
...
//   const lsi = saltId
//     ? (saturation_indices[saltId]?.SR ?? p.si ?? 0)
//     : (p.si ?? 0);
...
//       // Real points supplied — map them directly
//       gridResults = rawPoints.map((p: any) => mapPointToGridResult(p, saltId));
//     } else {
//       // No points array — synthesize a bar for every CoC × Temp combination
//       // so the 3-D chart always has something to render from axis values alone.
...
//                               }`}
//                             >
//                               {entry?.SR != null ? entry.SR.toFixed(4) : "—"}
//                             </span>
//                           </div>
//                         );
//                       })}
