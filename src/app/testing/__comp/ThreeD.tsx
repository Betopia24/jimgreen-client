...
// // Bottom panel resize constants
// const BOTTOM_PANEL_MIN_H = 120;
// const BOTTOM_PANEL_MAX_H = 700;
// const BOTTOM_PANEL_DEFAULT_H = 340;
...
//   // ── Bottom panel vertical resize state ──────────────────────────────────────
//   const [bottomPanelHeight, setBottomPanelHeight] = useState(BOTTOM_PANEL_DEFAULT_H);
//   const isResizingBottomRef = useRef(false);
//   const resizeBottomStartYRef = useRef(0);
//   const resizeBottomStartHeightRef = useRef(BOTTOM_PANEL_DEFAULT_H);
//   // Track whether user is hovering the resize handle (for visual feedback)
//   const [isHoveringBottomHandle, setIsHoveringBottomHandle] = useState(false);
...
//       resizeBottomStartYRef.current = e.clientY;
//       resizeBottomStartHeightRef.current = bottomPanelHeight;
...
//       // Dragging UP (negative delta) = larger panel; DOWN = smaller
//       const delta = resizeBottomStartYRef.current - e.clientY;
//       const newH = Math.min(
//         BOTTOM_PANEL_MAX_H,
//         Math.max(BOTTOM_PANEL_MIN_H, resizeBottomStartHeightRef.current + delta),
//       );
...
//           {/* ══════════════════════════════════════════════════════════════
//               BOTTOM PANEL — vertically resizable by dragging top border
//           ══════════════════════════════════════════════════════════════ */}
//           {bottomPanelData && hasBottomData && (
//             <div
//               className="shrink-0 border-t-2 border-slate-300 bg-white overflow-hidden flex flex-col"
//               style={{
//                 height: bottomPanelOpen ? bottomPanelHeight : 0,
//                 minHeight: bottomPanelOpen ? BOTTOM_PANEL_MIN_H : 0,
//                 transition: isResizingBottomRef.current
//                   ? "none"
//                   : "height 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
//               }}
//             >
//               {/* ── Drag-resize handle ─────────────────────────────────────
//                   A 10px tall strip at the very top of the panel.
//                   Cursor changes to row-resize on hover.
//                   When dragging up → panel grows; down → shrinks.
//               ───────────────────────────────────────────────────────── */}
//               <div
//                 onMouseDown={onBottomResizeMouseDown}
//                 onMouseEnter={() => setIsHoveringBottomHandle(true)}
//                 onMouseLeave={() => setIsHoveringBottomHandle(false)}
//                 className="shrink-0 w-full flex items-center justify-center transition-colors"
//                 style={{
//                   height: 10,
//                   cursor: "row-resize",
//                   background: isHoveringBottomHandle
//                     ? "rgba(59,130,246,0.18)"
//                     : "transparent",
//                   borderTop: isHoveringBottomHandle
...
//                     width: 16,
//                     height: 16,
//                     opacity: isHoveringBottomHandle ? 0.7 : 0.25,
//                     color: isHoveringBottomHandle ? "#3b82f6" : "#94a3b8",
//                     pointerEvents: "none",
//                   }}
//                 />
//               </div>
