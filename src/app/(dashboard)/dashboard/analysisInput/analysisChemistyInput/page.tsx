...
// export default function AnalysisChemistyInput() {
...
//       alert("data submited");
//     }
//     // router.push("/dashboard/analysisInput/comparison")s
...
//                     className={`w-full px-4 py-3 bg-[#F3F3F3] rounded-[8px] placeholder-#B4B4B4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
//                       errors[param.name] ? "border-red-500" : "border-gray-200"
//                     }`}
//                   />
//                   {errors[param.name] && (
...
import ComprehensiveWaterChemistryForm from "@/components/dashboard/analysisInput/AnalysisFormShow";
import React from "react";

const page = () => {
  return (
    <div>
      <ComprehensiveWaterChemistryForm />
    </div>
  );
};
